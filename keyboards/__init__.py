...
from .menu_kb import get_main_menu, get_cs_menu, get_unregistered_menu
from .onboarding_kb import get_status_kb, get_phone_kb, get_confirmation_kb
from .incident_kb import get_categories_kb, get_ticket_cs_actions_kb
from .emergency_kb import get_emergency_kb
from .cs_kb import get_registration_validation_kb, get_announcement_levels_kb, get_announcement_actions_kb
from .finance_kb import get_finance_resident_kb, get_finance_cs_kb
